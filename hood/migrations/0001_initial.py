# Generated by Django 3.0.4 on 2020-03-24 14:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_type', models.CharField(choices=[('SUPER ADMIN', 'SUPER ADMIN'), ('ADMIN', 'ADMIN'), ('USER', 'USER')], default='USER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept_type', models.CharField(choices=[('health', 'health'), ('authorities', 'authorities')], default='health', max_length=20)),
                ('neighbourhood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hood.Neighbourhood')),
            ],
        ),
        migrations.CreateModel(
